 ...
 */
public abstract class Hilt_ViewPagerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewPagerFragment() {
    super();
  }

  Hilt_ViewPagerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewPagerFragment_GeneratedInjector) this.generatedComponent()).injectViewPagerFragment(UnsafeCasts.<ViewPagerFragment>unsafeCast(this));
    }
  }
