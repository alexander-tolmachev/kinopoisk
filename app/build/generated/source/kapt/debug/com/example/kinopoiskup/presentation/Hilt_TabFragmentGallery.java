 ...
 */
public abstract class Hilt_TabFragmentGallery extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TabFragmentGallery() {
    super();
  }

  Hilt_TabFragmentGallery(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TabFragmentGallery_GeneratedInjector) this.generatedComponent()).injectTabFragmentGallery(UnsafeCasts.<TabFragmentGallery>unsafeCast(this));
    }
  }
