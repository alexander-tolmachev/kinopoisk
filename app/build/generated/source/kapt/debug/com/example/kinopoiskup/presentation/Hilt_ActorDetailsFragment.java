 ...
 */
public abstract class Hilt_ActorDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ActorDetailsFragment() {
    super();
  }

  Hilt_ActorDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActorDetailsFragment_GeneratedInjector) this.generatedComponent()).injectActorDetailsFragment(UnsafeCasts.<ActorDetailsFragment>unsafeCast(this));
    }
  }
