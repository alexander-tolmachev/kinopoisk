 ...
 */
public abstract class Hilt_PlainListHorizontalFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlainListHorizontalFragment() {
    super();
  }

  Hilt_PlainListHorizontalFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlainListHorizontalFragment_GeneratedInjector) this.generatedComponent()).injectPlainListHorizontalFragment(UnsafeCasts.<PlainListHorizontalFragment>unsafeCast(this));
    }
  }
