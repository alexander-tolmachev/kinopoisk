...
public final class FragmentResultBinding implements ViewBinding {
  ...
  private FragmentResultBinding(@NonNull ConstraintLayout rootView, @NonNull Button resultButton) {
  ...
  public static FragmentResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentResultBinding((ConstraintLayout) rootView, resultButton);
    }
