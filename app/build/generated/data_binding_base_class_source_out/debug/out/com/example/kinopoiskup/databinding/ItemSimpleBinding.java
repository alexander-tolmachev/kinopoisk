...
public final class ItemSimpleBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatTextView textLine;

  private ItemSimpleBinding(@NonNull AppCompatTextView rootView,
      @NonNull AppCompatTextView textLine) {
  ...
  public static ItemSimpleBinding bind(@NonNull View rootView) {
    ...
    AppCompatTextView textLine = (AppCompatTextView) rootView;

    return new ItemSimpleBinding((AppCompatTextView) rootView, textLine);
  }
}
