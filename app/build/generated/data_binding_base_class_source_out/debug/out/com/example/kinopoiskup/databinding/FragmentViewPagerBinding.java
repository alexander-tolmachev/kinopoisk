...
public final class FragmentViewPagerBinding implements ViewBinding {
  ...
  @NonNull
  public final ViewPager2 myPager2;
  ...
  private FragmentViewPagerBinding(@NonNull ConstraintLayout rootView, @NonNull ViewPager2 myPager2,
      @NonNull TabLayout tabs, @NonNull TextView tv) {
    this.rootView = rootView;
    this.myPager2 = myPager2;
    this.tabs = tabs;
    this.tv = tv;
  }
  ...
  public static FragmentViewPagerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.myPager2;
      ViewPager2 myPager2 = ViewBindings.findChildViewById(rootView, id);
      if (myPager2 == null) {
        break missingId;
      }
      ...
      return new FragmentViewPagerBinding((ConstraintLayout) rootView, myPager2, tabs, tv);
    }
